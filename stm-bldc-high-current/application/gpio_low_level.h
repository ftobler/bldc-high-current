 ...
 */
#define gpio_ll_set_pp(port, pin)        ((port)->BSRR = (uint32_t)(pin))
 ...
 */
#define gpio_ll_reset_pp(port, pin)      ((port)->BRR = (uint32_t)(pin))
 ...
 */
#define gpio_ll_read_pp(port, pin)       ((port)->IDR & (uint16_t)(pin))




#define gpio_ll_set(name)                 gpio_ll_set_pp(name##_GPIO_Port, name##_Pin)
#define gpio_ll_reset(name)               gpio_ll_reset_pp(name##_GPIO_Port, name##_Pin)
#define gpio_ll_write(name, state)        gpio_ll_write_pp(name##_GPIO_Port, name##_Pin, state)
#define gpio_ll_read(name)                gpio_ll_read_pp(name##_GPIO_Port, name##_Pin)
